    ...
    return (
        <>
            ...
            <div className={styles.aboutMeText}>
                <div>I am a software developer with 7+ years of experience. I have worked in full-stack development positions across 3 companies, building enterprise grade RESTful API services and polished front end web interfaces. I built this website using Next.js (Typescript) and hosted it on AWS Amplify. I also build Agentic AI projects in my free time.</div>
                <br />
